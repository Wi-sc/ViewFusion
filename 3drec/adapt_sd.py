...
def load_objaverse_model(ckpt_root):
    ...
    # ckpt_fname = '../zero123/logs/2023-06-10T11-42-05_sd-abo-finetune-c_concat-256/checkpoints/trainstep_checkpoints/epoch=000249-step=000000999.ckpt'
    # cfg_fname = '../zero123/configs/sd-objaverse-finetune-c_concat-256.yaml'
    cfg_fname = '../zero123/configs/sd-swap_att-c_concat-256.yaml'
    
    # ckpt_fname = '/home/ubuntu/workspace/zero123/zero123/logs/2023-08-03T07-44-48_sd_abo_diffusion_pbr_view90/checkpoints/epoch=000027.ckpt'
    # cfg_fname='/home/ubuntu/workspace/zero123/zero123/configs/sd-objaverse-finetune-c_concat-256.yaml'
    H, W = 256, 256
