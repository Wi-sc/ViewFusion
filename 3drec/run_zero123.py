...
def evaluate(score_model, vox, poser, folder_name=None):
    ...
    if folder_name is not None:
        vox.export_mesh(f"{folder_name}/model_m20.obj", threshold_mult=20)
        vox.export_mesh(f"{folder_name}/model_m18.obj", threshold_mult=18)
        vox.export_mesh(f"{folder_name}/model_m16.obj", threshold_mult=16)
        vox.export_mesh(f"{folder_name}/model_m14.obj", threshold_mult=14)
        vox.export_mesh(f"{folder_name}/model_m12.obj", threshold_mult=12)
        vox.export_mesh(f"{folder_name}/model_m10.obj", threshold_mult=10)
        vox.export_mesh(f"{folder_name}/model_m8.obj", threshold_mult=8)
        vox.export_mesh(f"{folder_name}/model_m6.obj", threshold_mult=6)
        vox.export_mesh(f"{folder_name}/model_m4.obj", threshold_mult=4)
        vox.export_mesh(f"{folder_name}/model_m2.obj", threshold_mult=2)
