...
class LatentDiffusion(DDPM):
    ...
    def __init__(self,
        ...
        self.instantiate_brdf_unet_stage(brdf_unet_config)
    ...
    def instantiate_brdf_unet_stage(self, config):
        model = instantiate_from_config(config)
        self.brdf_unet = model.eval()
        self.brdf_unet.train = disabled_train
        for param in self.brdf_unet.parameters():
